...
public class NewMemberActivity extends AppCompatActivity implements NewMemberAdapter.OnMemberItemClickListener {
        ...
        call.enqueue(new Callback<List<MemberModal>>() {
            ...
            public void onResponse(@NonNull Call<List<MemberModal>> call, @NonNull Response<List<MemberModal>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(NewMemberActivity.this, "Failed to load members", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<List<MemberModal>> call, Throwable t) {
                ...
                Toast.makeText(NewMemberActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
            }
        });
    }
